...
{
    public partial class add_Debit : Form
    {
        ...
        private void add_Debit_Load(object sender, EventArgs e)
        {
        ...
        private void Save_button_Click(object sender, EventArgs e)
        {
            //if (varify() == true)
            //{
            //    if (DebitControl.type == "Add")
            //    {
            //        journal.InsertJournal(jornal_dateTime.Text, Account_CB.Text, Description_richTextBox.Text, Convert.ToDecimal(DR_textbox.Text),0);
            //        journal.InsertJournal(jornal_dateTime.Text, "Cash", Description_richTextBox.Text,0, Convert.ToDecimal(DR_textbox.Text));
            //        decimal balance1 = journal.GetValue("Cash");
            //        decimal balance2 = journal.GetValue(Account_CB.Text);
            //        decimal balance3 = Convert.ToDecimal(DR_textbox.Text);
            //        acc.EditAccount(Account_CB.Text,(balance2+balance3).ToString());
            //        acc.EditAccount("Cash", (balance1 - balance3).ToString());
            //    }
            //    else
            //    {
            //        journal.EditJournal(jornal_dateTime.Text, Account_CB.Text, Description_richTextBox.Text, Convert.ToDecimal(DR_textbox.Text),0,
            //            DebitControl.JournalID);
            //        journal.EditJournal(jornal_dateTime.Text, "Cash", Description_richTextBox.Text,0, Convert.ToDecimal(DR_textbox.Text),
            //            DebitControl.JournalID+1);
            //        decimal balance1 = journal.GetValue("Cash");
            //        decimal balance2 = journal.GetValue(Account_CB.Text);
            //        decimal balance3 = Convert.ToDecimal(DR_textbox.Text);
            //        acc.EditAccount(Account_CB.Text, (balance2 + balance3).ToString());
        ...
        private void Save_button_Click_2(object sender, EventArgs e)
        {
            if (varify() == true)
            {
                if (CreditControl.type == "Add")
                {
                    int i = journal.InsertVoucher(dateTimePicker1.Text);
                    journal.InsertJournal(i, 1, 1, DRAccount_CB.Text, Description_richTextBox.Text, Convert.ToDecimal(DR_textbox.Text)
                        , 0, dateTimePicker1.Text);
                    journal.InsertJournal(i, 2, 1, CRAccount_CB.Text, Description_richTextBox.Text, 0, Convert.ToDecimal(CR_textBox.Text)
                        , dateTimePicker1.Text);
                    decimal balance1 = journal.GetValue(CRAccount_CB.Text);
                    decimal balance2 = journal.GetValue(DRAccount_CB.Text);
                    decimal balance3 = Convert.ToDecimal(DR_textbox.Text);
                ...
                {
                    journal.EditJournal(CreditControl.VoucherID, 1, 1, DRAccount_CB.Text, Description_richTextBox.Text,
                        Convert.ToDecimal(DR_textbox.Text), 0, dateTimePicker1.Text);
                    journal.EditJournal(CreditControl.VoucherID, 2, 1, CRAccount_CB.Text, Description_richTextBox.Text, 0,
                        Convert.ToDecimal(CR_textBox.Text), dateTimePicker1.Text);
                    decimal balance1 = journal.GetValue(CRAccount_CB.Text);
                    decimal balance2 = journal.GetValue(DRAccount_CB.Text);
                    decimal balance3 = Convert.ToDecimal(DR_textbox.Text);
