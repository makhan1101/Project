...
namespace Store_Management
{
    public partial class CreditControl : UserControl
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                DataTable dta = Journal.Search("0", "0", null, null,2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text != "All" && Before_c.Checked == false && After_c.Checked == false)
            {
                DataTable dta = Journal.Search("0", AccountTitle_CB.Text, null, null, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text == "All" && Before_c.Checked == true && After_c.Checked == true)
            {
                DataTable dta = Journal.Search("DateFull", "Date", Before_dp.Text, After_dp.Text, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text == "All" && Before_c.Checked == true && After_c.Checked == false)
            {
                DataTable dta = Journal.Search("Before", "Date", Before_dp.Text, null, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text == "All" && Before_c.Checked == false && After_c.Checked == true)
            {
                DataTable dta = Journal.Search("After", "Date", null, After_dp.Text, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text != "All" && Before_c.Checked == true && After_c.Checked == true)
            {
                DataTable dta = Journal.Search("DateFull", AccountTitle_CB.Text, Before_dp.Text, After_dp.Text, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text != "All" && Before_c.Checked == true && After_c.Checked == false)
            {
                DataTable dta = Journal.Search("DateBefore", AccountTitle_CB.Text, Before_dp.Text, null, 2);
                initialize(dta);
            }
            else if (AccountTitle_CB.Text != "All" && Before_c.Checked == false && After_c.Checked == true)
            {
                DataTable dta = Journal.Search("DateAfter", AccountTitle_CB.Text, null, After_dp.Text, 2);
                initialize(dta);
            }
        }
